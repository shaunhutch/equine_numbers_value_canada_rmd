...
Next we look at the range of the number horses for each provinces at any time point between `r min(horse_pop$Ref_Date)` to `r max(horse_pop$Ref_Date)`.
...
```{r plot province, fig.align='center', fig.cap="Figure2. Historical number of horses per province in Canada", fig.height=4, fig.width=5, message=FALSE, warning=FALSE}
